<script lang="ts">
	...
	const softwareSchema = JSON.stringify({
		...
		operatingSystem: "Web",
		description: "Free, private toolkit with 39 tools for PDFs, images, and developer workflows — all running in your browser. No uploads, no server.",
		url: "https://localconvert.app",
		offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
		featureList: [
			"No server uploads \u2014 100% local processing",
			"21 PDF tools (merge, split, compress, watermark, sign, edit, Word/Excel to PDF, and more)",
