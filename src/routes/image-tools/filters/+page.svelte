...
<div class="filter-page">
	...
	<div class="filter-header">
		...
		<div>
			<h1 class="text-2xl font-semibold">{m['tool_pages.filters.title']()}</h1>
			<p class="text-sm text-muted">{m['tool_pages.filters.desc']()}</p>
		</div>
	</div>
...
<style>
	...
	.filter-header { display: flex; align-items: center; gap: 0.75rem; }
