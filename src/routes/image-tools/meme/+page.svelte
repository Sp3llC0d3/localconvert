	...
	{#if imgEl}
		...
		<div class="opt-section">
			<div class="opt-row">
				...
				<input id="meme-top" type="text" bind:value={topText} placeholder={aria_meme_top_text()} class="opt-input flex-1" maxlength={100} />
			</div>
			<div class="opt-row">
				<label class="opt-label" for="meme-bottom">{tool_pages_meme_bottom_text()}</label>
				<input id="meme-bottom" type="text" bind:value={bottomText} placeholder={aria_meme_bottom_text()} class="opt-input flex-1" maxlength={100} />
			</div>
		</div>
